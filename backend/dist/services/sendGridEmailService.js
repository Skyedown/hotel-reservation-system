...
exports.sendGridEmailService = exports.SendGridEmailService = void 0;
...
class SendGridEmailService {
    ...
    async sendEmail(to, template, emailType, reservationId) {
        if (!this.initialized) {
    ...
    generateCheckInReminder24H(reservation) {
...
<body>
  <div class="container">
    ...
    generatePaymentConfirmationEmail(reservation) {
        const managementUrl = `${process.env.FRONTEND_URL}/reservation/${reservation.accessToken}`;
        const checkInDate = new Date(reservation.checkIn);
        const checkOutDate = new Date(reservation.checkOut);
        return {
...
<body>
  <div class="container">
    ...
    async sendCheckInReminder24H(reservation) {
    ...
    async sendMultiRoomPaymentConfirmationEmail(reservations) {
    ...
    generateMultiRoomPaymentConfirmationEmail(reservations) {
        if (reservations.length === 0) {
...
<body>
  <div class="container">
    ...
    async markReminderAsSent(reservationId, emailType) {
        try {
    ...
    async markReminderAsFailed(reservationId, emailType, errorMessage) {
        try {
            await prisma.emailReminder.updateMany({
                where: {
                    reservationId,
...
exports.sendGridEmailService = new SendGridEmailService();
